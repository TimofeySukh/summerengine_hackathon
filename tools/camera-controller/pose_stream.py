...
def main() -> int:
    ...
    audio_player = None
    if args.game_bridge or not args.no_audio or voice_detector is not None:
        voice_callback = None
        ...
        if not args.no_audio:
            print(f"Audio: {args.audio} (playback on; single client)")
        elif voice_detector is not None:
            print(f"Audio: {args.audio} (playback off; voice wave + shockwave monitor)")
        else:
